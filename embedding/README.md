...
│   ├── EMBEDDING_MODEL_CHANGELOG.md     # Changelog for embedding model updates
│   └── EVOLUTION_ANALYSIS_REPORT.md     # Analysis report of system evolution
...
│       └── qdrant_utils.py              # Qdrant client connection functionality
...
```bash
QDRANT_URL="your_qdrant_url" QDRANT_API_KEY="your_api_key" python src/cli/store_enhanced_embeddings_to_qdrant.py
```

### Query FAQs from Qdrant:
```bash
QDRANT_URL="your_qdrant_url" QDRANT_API_KEY="your_api_key" python src/cli/query_faqs_qdrant.py
```
